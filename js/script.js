...
const Translations = (() => {
  const data = {
    ...
    en: {
      ...
      skillsTitle:     'Skills',
      techStackTitle: 'Technology & Programming',
      techStackDesc: 'Programming, automation, web development & data processing',
      pythonDesc: 'Automation • Data Processing • Web Scraping',
      phpDesc: 'Backend Development • API • Dynamic Website',
      jsDesc: 'Interactive UI • Frontend Logic • Web Experience',
      cssDesc: 'Responsive Design • Animation • Modern Layout',
      sqlDesc: 'Database • Query Optimization • Structured Data',
      dockerDesc: 'Containerization • Deployment • Development Environment',
      hospitalityTitle: 'Hospitality & Operational',
      hospitalityDesc: 'Professional experience in service, operations & teamwork',
      operatorTitle: 'Packing Operator',
      operatorDesc: 'Packing • Production Flow • Quality Control',
      waiterDesc: 'Customer Service • Communication • Hospitality',
      housekeepingDesc: 'Cleanliness • Attention to Detail • Discipline',
      teamworkDesc: 'Collaboration • Coordination • Responsibility',
      communicationDesc: 'Public Interaction • Problem Solving • Adaptability',
...
`,
    ...
    id: {
      ...
      techStackTitle: 'Teknologi & Programming',
      techStackDesc: 'Programming, automation, pengembangan web & pengolahan data',
      pythonDesc: 'Automasi • Pengolahan Data • Web Scraping',
      phpDesc: 'Backend Development • API • Website Dinamis',
      jsDesc: 'UI Interaktif • Logika Frontend • Pengalaman Web',
      cssDesc: 'Desain Responsif • Animasi • Layout Modern',
      sqlDesc: 'Database • Optimasi Query • Data Terstruktur',
      dockerDesc: 'Containerization • Deployment • Development Environment',
      hospitalityTitle: 'Hospitality & Operasional',
      hospitalityDesc: 'Pengalaman profesional dalam pelayanan, operasional & kerja tim',
      operatorTitle: 'Operator Packing',
      operatorDesc: 'Packing • Alur Produksi • Kontrol Kualitas',
      waiterDesc: 'Pelayanan Pelanggan • Komunikasi • Hospitality',
      housekeepingDesc: 'Kebersihan • Ketelitian • Disiplin',
      teamworkDesc: 'Kolaborasi • Koordinasi • Tanggung Jawab',
      communicationDesc: 'Interaksi Publik • Problem Solving • Adaptabilitas',
